...
class HttpListAdapter(val musicList: List<Song>, context: Context) :
    RecyclerView.Adapter<HttpListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.https_music_item, parent, false)
